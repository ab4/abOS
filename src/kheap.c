...
extern u32int end; // in link.ld
extern page_directory_t * kernel_directory; // in paging.c

// placement heap related
u32int placement_address = (u32int)&end; 

static u32int kmalloc_internal(u32int sz, int align, u32int *phys);
...
// used by interface functions
static u32int kmalloc_internal(u32int sz, int align, u32int *phys)
{
  if(kheap != 0) // heap active
  {
  ...
  if (align == 1 && (placement_address & 0x00000FFF)) // 0xFFFFF000 in tutorial
  {
    // Align it.
